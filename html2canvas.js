...
(function (global, factory) {
  ...
  ***************************************************************************** */
    ...
    parse: function (context, value) {
      if (value.type === 18 /* FUNCTION */ ) {
        ...
        if (typeof colorFunction !== 'undefined') {
          ...
          ret = colorFunction(context, value.values);
        }
        return ret;
      }
    ...
    for (var childNode = node.firstChild, nextNode = void 0; childNode; childNode = nextNode) {
      ...
      if (isTextNode(childNode) && childNode.data.trim().length > 0) {
        ...
        if (isSlotElement(childNode) && childNode.assignedNodes) {
          ...
          var container = createContainer(context, childNode, node);
  ...
  var createContainer = function (context, element, node) {
    if (isImageElement(element)) {
      let tItem = new ImageElementContainer(context, element);
      let styles = window.getComputedStyle(node.querySelector("img"));
      tItem.styles['objectFit'] = styles['object-fit'];
      return tItem;
    }
  ...
  var CanvasRenderer = /** @class */ (function (_super) {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              // styles = window.getComputedStyle(stack.element.container);
    ...
    CanvasRenderer.prototype.renderReplacedElement = function (container, curves, image) {
      ...
      if (image && container.intrinsicWidth > 0 && container.intrinsicHeight > 0) {
        ...
        if (objectFit === 'contain' || objectFit === 'cover' || objectFit === 'cover') {
          const {
            width,
            height,
            x,
            y
          } = getObjectFitSize(objectFit === 'contain', box.width, box.height, image.width, image.height);
          newWidth = width;
          newHeight = height;
